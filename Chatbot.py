...
class VoiceChatbot:
    def __init__(self):
        self.cohere = cohere.Client("4vyKzt01CslUjmkj4BnVEafek2fy7Q5K0WPSwmOz")  # This my actual Cohere API key
        self.elevenlabs = ElevenLabs(api_key="sk_03e4477254a6c6da877624ed4acd4f767abfaa9a13fc0de7")  # This is my actual ElevenLabs API key
    ...
    def think(self, text):
        response = self.cohere.chat(model="command-r7b-arabic-02-2025",message=text,temperature=0.7,max_tokens=200, preamble="جاوب بلهجة سعودية فقط، جاوب بشكل مختصر، اسمك هو المساعد الذكي وقد صممتك ميرال محمد")
